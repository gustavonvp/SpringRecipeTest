...
public class RecipeToRecipeCommand implements Converter<RecipeCommand, Recipe> {
    ...
    public RecipeToRecipeCommand(CategoryCommandToCategory categoryConverter, IngredientCommandToIngredient ingredientConverter, NotesCommandToNotes notesConverter) {
    ...
    public Recipe convert(RecipeCommand source) {
        ...
        recipe.setDifficult((source.getDifficulty()));
